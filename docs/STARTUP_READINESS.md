...
- 132 von 132 Tests einschließlich lokalem IRC-Integrationstest erfolgreich
- Ruff ohne Befund
...
| CTCP-Basis | fertig | `ACTION`, `PING`, `CLIENTINFO` und immer aktive native Bot-Version; nur ein sicherer Zusatztext ist konfigurierbar |
